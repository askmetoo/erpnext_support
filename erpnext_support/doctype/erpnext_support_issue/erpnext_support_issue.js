...
frappe.ui.form.on("ERPNext Support Issue", {
	...
	refresh: function(frm) {
		...
		if (frm.doc.status === "Closed" && !frm.doc.support_rating && !frm.doc.add_a_comment) {
			get_feedback(frm);
		}
...
function make_reply_button(frm) {
	...
	$(".timeline-new-email").append("<button class='btn btn-default btn-new-reply btn-xs'>New Reply</button>");
